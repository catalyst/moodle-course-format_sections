...
/**
 * Format sections section extra logic component.
 *
 * @module     format_sections/section
...
class HighlightSection extends BaseComponent {
    ...
    create() {
        ...
        this.name = 'format_sections_section';
        ...
        // The sections format section specific actions.
        this.formatActions = {
