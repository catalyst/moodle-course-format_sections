 ...
 *
 * @module     format_sections/mutations
...
class SectionsMutations extends DefaultMutations {
...
export const init = () => {
    ...
    courseEditor.addMutations(new SectionsMutations());
