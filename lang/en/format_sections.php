...
$string['page-course-view-sections'] = 'Any course main page in custom sections format';
$string['page-course-view-sections-x'] = 'Any course page in custom sections format';
